...
TEST(TestAssembleLoadVector, SingleTriangle) {
	...
	computeLoadVector(loadVector, vertices.row(0), vertices.row(1), vertices.row(2), f);
...
TEST(TestAssembleLoadVector, TwoTriangles) {
	...
	computeLoadVector(loadVectorLowerTriangle, vertices.row(0), vertices.row(1), vertices.row(2), f);

	Eigen::Vector3d loadVectorUpperTriangle;
	computeLoadVector(loadVectorUpperTriangle, vertices.row(1), vertices.row(3), vertices.row(2), f);
